public class Iteration3 {
    ...
    // Opgave 1.1
        ...
        public static void main(String[] args) {
            ...
            System.out.println("Health before: " + healthPoints);

            healthPoints = takeDamage(healthPoints, 30);

            System.out.println("Health after: " + healthPoints);
        }
        ...
        int heal(int currentHealth, int amount, int maxHealth) {
 ...
 //  Opgebeskrivelse: addXP(int amount) — lægger experience points til karakteren

    int addXP(int currentXP, int amount) {
        return currentXP + amount;
    }

    // Opgbeskrivele - boolean  - returnerer true hvis karakteren har health over 0, ellers false

    boolean isAlive(int currentHealth) {
    ...
    boolean isHealthCritical(int currentHealth, int maxHealth) {
    ...
    double getHealthPercentage(int currentHealth, int maxHealth) {
